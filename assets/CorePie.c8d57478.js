...
import { g as IxChart, s as setup } from "./setup.80443e3d.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const option = {
      title: {
        text: `${data.reduce((curr, next) => curr + next.value, 0)}`,
        subtext: "\u7EDF\u8BA1\u6570\u91CF",
        textStyle: {
          fontSize: "30px"
        },
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_IxChart, mergeProps({ style: { "height": "300px" } }, option), null, 16);
    };
  }
});
const title = "\u997C\u56FE";
...
if (typeof block0 === "function")
  block0(_sfc_main);
const Component = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/vm/workspace/vue/idux-charts/packages/site/src/components/core/demos/CorePie.vue"]]);
const CorePie = {
  "id": "archive-item-9",
  "filename": "CorePie.vue",
  "relativePath": "components/core/demos/CorePie.vue",
  "query": {},
  "title": "\u997C\u56FE",
  "description": "",
  "index": 7,
  "sourceCodes": [{ "filename": "CorePie.vue", "code": `<script setup lang="ts">
