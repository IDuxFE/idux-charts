...
if (typeof block0 === "function")
  block0(_sfc_main);
const Component = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/work/codes/idux-charts/packages/site/src/components/core/demos/CorePie.vue"]]);
const __archive_data__ = {
  ...
  "description": "",
  "index": 7,
  "sourceCodes": [{ "filename": "CorePie.vue", "code": `<script setup lang="ts">\r
...
const option: ChartProps = {\r
  title: {\r
    text: \`\${data.reduce((curr, next) => curr + next.value, 0)}\`,\r
    subtext: '统计数量',\r
    textStyle: {\r
      fontSize: '30px',\r
    },\r
