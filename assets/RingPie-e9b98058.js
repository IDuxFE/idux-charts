...
import { L as LinearGradient, q as IxPieChart, s as setup } from "./setup-1f0c886d.js";
...
if (typeof block0 === "function")
  block0(_sfc_main);
const Component = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/work/codes/idux-charts/packages/site/src/components/pie/demos/RingPie.vue"]]);
const __archive_data__ = {
  ...
  "description": "",
  "index": 1,
  "sourceCodes": [{ "filename": "RingPie.vue", "code": `<script setup lang="ts">\r
import { type PieChartProps } from '@idux/charts'\r
import { graphic } from 'echarts/core'\r
import { PieSeriesOption } from 'echarts/charts'\r
\r
type DataItem = PieSeriesOption['data']\r
\r
const getLinearGradient = (start: string, end: string) => {\r
  return new graphic.LinearGradient(0, 0, 1, 1, [\r
    {\r
      offset: 0,\r
      color: start, // 渐变起始颜色\r
    },\r
    {\r
      offset: 1,\r
      color: end, // 渐变结束颜色\r
  ...
  for (var i = 0; i < 100; i++) {\r
    if (i % 2 === 0) {\r
      dataArr.push({\r
        ...
        value: 25,\r
        itemStyle: {\r
          color: 'rgb(126,190,255)',\r
          borderWidth: 0,\r
          borderColor: 'rgba(0,0,0,0)',\r
        },\r
      })\r
    } else {\r
      dataArr.push({\r
...
const data = [\r
  {\r
    ...
    name: '高危',\r
    itemStyle: {\r
      color: getLinearGradient('rgba(104, 159, 255, 1)', 'rgba(104, 159, 255, 0.2)'),\r
    },\r
  },\r
  {\r
    value: 124,\r
    name: '中危',\r
    itemStyle: {\r
      color: getLinearGradient('rgba(255, 146, 69, 1)', 'rgba(255, 146, 69, 0.2)'),\r
    },\r
  },\r
  {\r
    value: 118,\r
    name: '低危',\r
    itemStyle: {\r
      color: getLinearGradient('rgba(219, 76, 53, 1)', 'rgba(219, 76, 53, 0.2)'),\r
    },\r
  },\r
]\r
\r
...
\r
  title: {\r
    // 总数\r
    text: String((data || []).reduce((acc, cur) => acc + cur.value, 0)),\r
    // 标题\r
    textStyle: {\r
      fontSize: 24,\r
      fontWeight: 500,\r
      color: '#2F3540',\r
      fontFamily: 'D-DIN-PRO',\r
    },\r
    subtextStyle: {\r
      fontSize: 12,\r
      fontWeight: 400,\r
...
\r
  ...
  series: [\r
    ...
    {\r
      ...
      silent: true,\r
      itemStyle: {\r
        color: getLinearGradient('rgba(69, 143, 255, 0.08)', 'rgba(69, 143, 255, 0.01)'),\r
      },\r
      label: {\r
        show: false,\r
      },\r
...
\r
    ...
    {\r
      ...
      itemStyle: {\r
        borderColor: getLinearGradient('rgba(69, 143, 255, 0.16)', 'rgba(69, 143, 255, 0)'),\r
        borderWidth: 1,\r
        color: getLinearGradient('rgba(69, 143, 255, 0.1)', 'rgba(69, 143, 255, 0)'),\r
      },\r
      data: [1],\r
    },\r
  ],\r
...
<template>\r
  <IxPieChart\r
    style="width: 600px; height: 300px"\r
    name="风险用户数"\r
    v-bind="pieOption"\r
  />\r
