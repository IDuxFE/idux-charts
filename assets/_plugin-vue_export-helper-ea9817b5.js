...
function watch$1(source, cb, options = EMPTY_OBJ) {
  ...
  boundCleanup = (fn2) => onWatcherCleanup(fn2, false, effect);
...
function H(t, e, n, r, a, o) {
  ...
  var p2 = u ? c ? Te : ka : c ? ct : st, y = v ? void 0 : p2(t);
...
function Di(t) {
  ...
  const r = ref(/* @__PURE__ */ new Set()), a = () => [...r.value.values()].map(
    ...
    o();
    const g = reactive({ component: u, props: v != null ? v : {}, key: `instance-${n++}`, el: c });
  ...
  return (c) => {
    ...
    function w(p2, y) {
      ...
      return W(p2) ? h2 = () => {
        ...
        var _a2;
        y == null ? void 0 : y((_a2 = u.props) == null ? void 0 : _a2[p2]);
      }, v.add(h2), () => {
        v.delete(h2);
      };
    }
    ...
    return {
      ...
      getProps() {
        if (!("props" in c))
          return [];
        const p2 = c.props, y = [];
        return p2 && Object.entries(p2).forEach(([h2, d]) => {
          let T, O;
      ...
      setData(p2) {
        var _a2;
        p2 || (u.props = void 0);
        const y = { ...(_a2 = u.props) != null ? _a2 : {}, ...p2 };
        u.props = y, g();
      },
      watchData: w
    };
