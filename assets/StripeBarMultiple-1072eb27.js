...
import { a as seerColors, I as IxBarChart, s as setup } from "./setup-1f0c886d.js";
import { u as useStripeBarTooltip, a as useStripeBarSeries } from "./useStripe-ca94b484.js";
...
if (typeof block0 === "function")
  block0(_sfc_main);
const Component = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/work/codes/idux-charts/packages/site/src/components/bar/demos/StripeBarMultiple.vue"]]);
const __archive_data__ = {
  ...
  "description": "",
  "index": 3,
  "sourceCodes": [{ "filename": "StripeBarMultiple.vue", "code": `<script setup lang="ts">\r
import {\r
  type BarChartProps,\r
  seerColors,\r
  useStripeBarTooltip,\r
  useStripeBarSeries,\r
} from '@idux/charts'\r
\r
...
\r
  tooltip: useStripeBarTooltip('次'),\r
\r
  series: [\r
    ...useStripeBarSeries({\r
      series: {\r
...
\r
    ...useStripeBarSeries({\r
      series: {\r
        name: '系列2',\r
        data: [120, 34, 136, 204, 198],\r
      },\r
      color: seerColors[1],\r
      offset: [0, 6],\r
    }),\r
  ],\r
}\r
<\/script>\r
<template>\r
  <IxBarChart style="height: 300px" :data="[]" v-bind="barOption" />\r
