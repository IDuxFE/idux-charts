...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_IxLineChart, mergeProps({ style: { "width": "100%", "height": "600px" } }, lineOption), null, 16);
    };
  }
});
const title = "\u5806\u53E0\u9762\u79EF\u56FE";
