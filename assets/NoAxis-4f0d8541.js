...
if (typeof block0 === "function")
  block0(_sfc_main);
const Component = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/work/codes/idux-charts/packages/site/src/components/line/demos/NoAxis.vue"]]);
const __archive_data__ = {
  ...
  "description": "",
  "index": 5,
  "sourceCodes": [{ "filename": "NoAxis.vue", "code": `<script setup lang="ts">\r
import { type LineChartProps, useLinearGradient, useLineStyleColor, getAlphaColor } from '@idux/charts'\r
\r
  ...
  series: [\r
    {\r
      ...
      lineStyle: { // 实现连线上的阴影效果\r
        shadowColor: getAlphaColor('#458FFF', 0.9),\r
        shadowBlur: 8,\r
        color: useLineStyleColor('#1c6eff'),\r
      },\r
    }\r
  ]\r
}\r
