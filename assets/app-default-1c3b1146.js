...
function resolveRoutes(routesRecords, theme, renderers, options) {
  return [
    ...
    ...routesRecords.map((record) => {
      return {
        path: record.path,
        component: () => __vitePreload(() => import("./Page-7b808b07.js"), true ? [] : void 0),
